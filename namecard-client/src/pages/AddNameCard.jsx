                        ...
                        {step === 2 && (
                            <div className="flex flex-col justify-center px-4 py-12">
                                ...
                                <div className="flex justify-between gap-4 items-center mt-4">
                                    <button type="button" onClick={prevStep} className="btn btn-accent w-40">Previous</button>
                                    <button type="button" onClick={nextStep} className="btn btn-primary w-40">Next</button>
                                </div>
                            </div>
                        )}
                        {step === 3 && (
